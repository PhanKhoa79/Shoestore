...
class ProductModel {
    ...
    public static function getAllProduct() {
        try {
            ...
            $query = "SELECT IdProduct, ImageProduct, NameProduct, Price, QuantityProduct, Size FROM prodcut"; 
            $stmt = $conn->prepare($query);
    ...
    public static function getAllProductsByCategory($category) {
        try {
            ...
            $query = "SELECT IdProduct, ImageProduct, NameProduct, Price, QuantityProduct, Size FROM prodcut WHERE id_category = :category"; 
            $stmt = $conn->prepare($query);
    ...
    public static function getAllProductsByBrand($brand) {
        try {
            $conn = connectDB();    

            $query = "SELECT IdProduct, ImageProduct, NameProduct, Price, QuantityProduct, Size FROM prodcut WHERE id_type = :type"; 
            $stmt = $conn->prepare($query);
            $stmt->bindParam(':type', $brand);
    ...
    public static function getProductById($productId) {
        try {
            $conn = connectDB();
            $query = "SELECT IdProduct, ImageProduct, NameProduct, Price, QuantityProduct, Status, Size FROM prodcut WHERE IdProduct = :productId";
            $stmt = $conn->prepare($query);
