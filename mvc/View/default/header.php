          ...
          <div class="header-top">
            ...
            <div class="header-top__right">
                <ul class="header-top__item-right">
                    ...
                    ?>
                        <li><a href="home.php?act=info"><?php echo $_SESSION['login']['user'];?></a></li>
                            ...
                            <div class="header-menu">
                                ...
                                <ul class="sub-menu">
                                    <li class="menu-item" id="all-products">
                                        <a href="category-product.php" onclick="updateCategoryPath('All')">Tất cả sản phẩm</a>
                                        <strong>New</strong>
                                    </li>
                                    <li class="menu-item" id="flash-sale">
                                        <a href="category-product.php?category=SALE" onclick="updateCategoryPath('Flash Sale')">Flash Sale</a>
                                        <strong>Hot</strong>
                                    </li>
                                    <li class="menu-item"><a href="category-product.php?category=ADS" onclick="updateCategoryPath('Giày Adidas')">Giày Adidas</a></li>
                                    <li class="menu-item"><a href="category-product.php?category=CV" onclick="updateCategoryPath('Giày Converse')">Giày Converse </a></li>
                                    <li class="menu-item"><a href="category-product.php?category=JORDAN" onclick="updateCategoryPath('Giày Jordan')">Giày Jordan</a></li>
                                    <li class="menu-item"><a href="category-product.php?category=LV" onclick="updateCategoryPath('Giày LV Trainer')">Giày LV Trainer</a></li>
                                    <li class="menu-item"><a href="category-product.php?category=MLB" onclick="updateCategoryPath('Giày MLB')">Giày MLB</a></li>
                                    <li class="menu-item"><a href="category-product.php?category=NIKE" onclick="updateCategoryPath('Giày Nike')">Giày Nike</a></li>
                                    <li class="menu-item"><a href="category-product.php?category=NB" onclick="updateCategoryPath('Giày NB')">Giày New Balance</a></li>
                                </ul>
                            </div>
                        </li>
                ...
                <nav class="header-nav" style="margin-right:8px">
                    <ul class="header-nav__list">
                        <li class="header-nav__item item-cart">
                            <a href="../layouts/cart.php" class="header-nav__link cart">
