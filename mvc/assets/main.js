...
function openPanel(panelName) {
  let i;
  let x = document.getElementsByClassName("tab-panel jordan-tab-panel filtering");
...
function openPanel2(panelName) {
  let i;
  let x = document.getElementsByClassName("tab-panel af-tab-panel filtering");
  for (i = 0; i < x.length; i++) {
    x[i].style.display = "none"; 
  }
  document.getElementById(panelName).style.display = "block"; 
  ...
  if (panelName === "af1") {
    $('.tab-af1.filtering').slick('unslick'); // Xóa thư viện cũ
    $('.tab-af1.filtering').slick({ // Khởi tạo lại thư viện
      slidesToShow: 5,
      slidesToScroll: 5,
      draggable: false,
      prevArrow: `<button type='button' class='slick-prev pull-left'><ion-icon name="arrow-back-outline"></ion-icon></button>`,
  ...
  } else if (panelName === "sb") {
    $('.tab-sb.filtering').slick('unslick'); // Xóa thư viện cũ
    $('.tab-sb.filtering').slick({ // Khởi tạo lại thư viện
      slidesToShow: 5,
      slidesToScroll: 5,
      draggable: false,
      prevArrow: `<button type='button' class='slick-prev pull-left'><ion-icon name="arrow-back-outline"></ion-icon></button>`,
...
function openPanel3(panelName) {
  let i;
  let x = document.getElementsByClassName("tab-panel ads-tab-panel filtering");
  for (i = 0; i < x.length; i++) {
    x[i].style.display = "none"; 
  }
  document.getElementById(panelName).style.display = "block"; 
  ...
  if (panelName === "ub") {
    $('.tab-ub.filtering').slick('unslick'); // Xóa thư viện cũ
    $('.tab-ub.filtering').slick({ // Khởi tạo lại thư viện
      slidesToShow: 5,
      slidesToScroll: 5,
      draggable: false,
      prevArrow: `<button type='button' class='slick-prev pull-left'><ion-icon name="arrow-back-outline"></ion-icon></button>`,
  ...
  } else if (panelName === "ss") {
    $('.tab-ss.filtering').slick('unslick'); // Xóa thư viện cũ
    $('.tab-ss.filtering').slick({ // Khởi tạo lại thư viện
      slidesToShow: 5,
      slidesToScroll: 5,
      draggable: false,
      prevArrow: `<button type='button' class='slick-prev pull-left'><ion-icon name="arrow-back-outline"></ion-icon></button>`,
...
function openPanel4(panelName) {
  let i;
  let x = document.getElementsByClassName("tab-panel nb-tab-panel filtering");
  for (i = 0; i < x.length; i++) {
    x[i].style.display = "none"; 
  }
  document.getElementById(panelName).style.display = "block"; 
  ...
  if (panelName === "nb550") {
    $('.tab-nb550.filtering').slick('unslick'); // Xóa thư viện cũ
    $('.tab-nb550.filtering').slick({ // Khởi tạo lại thư viện
      slidesToShow: 5,
      slidesToScroll: 5,
      draggable: false,
      prevArrow: `<button type='button' class='slick-prev pull-left'><ion-icon name="arrow-back-outline"></ion-icon></button>`,
  ...
  } else if (panelName === "nb300") {
    $('.tab-nb300.filtering').slick('unslick'); // Xóa thư viện cũ
    $('.tab-nb300.filtering').slick({ // Khởi tạo lại thư viện
      slidesToShow: 5,
      slidesToScroll: 5,
      draggable: false,
      prevArrow: `<button type='button' class='slick-prev pull-left'><ion-icon name="arrow-back-outline"></ion-icon></button>`,
